...
public class Hashids {
  ...
  public static final String DEFAULT_ALPHABET_USER = "ACEGIKMOQSUWY13579";
  public static final String DEFAULT_ALPHABET_GROUP = "BDFHJLNPRTVXZ24680";
...
public static void main(String[] args) {
	Hashids INVITE_USEAPP_HASHID = new Hashids("codrim user", 6, Hashids.DEFAULT_ALPHABET_USER);
	Hashids INVITE_JOINGROUP_HASHID = new Hashids("codrim group", 6, Hashids.DEFAULT_ALPHABET_GROUP);
	long[]  aa=	INVITE_USEAPP_HASHID.decrypt("YKQ31O");
System.out.println(INVITE_USEAPP_HASHID.encrypt(7059));

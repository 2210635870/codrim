...
<script type="text/javascript" src="${ctx}/res/js/productType.js"></script>
<style type="text/css">
body {
	margin: 0;
}
...
<body style="visibility: visible;">
	<table id="view" idField="id" rownumbers="true" pagination="true"
		...
		<thead>
			<tr>
				...
				<th field="productType" align="center" width="auto"
	...
	<div id="tb">
		<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true"
			onclick="newProductType()">新增</a> 
			<a href="#" class="easyui-linkbutton"
			iconCls="icon-edit" plain="true" onclick="editProductType()">编辑</a> 
			<a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true"
			onclick="removeProductType()">删除</a> 
	</div>
	<div id="dlg" class="easyui-dialog"
		style="width: 400px; height: 280px; padding: 10px 20px" closed="true"
		buttons="#dlg-buttons" modal="true">
		<div class="ftitle">广告类型信息</div>
		<form id="fm" method="post" novalidate>
			<div class="fitem">
				<label>类型名字:</label> <input name="productType" id="channelType"
	...
	<div id="dlg-buttons">
		<a href="#" class="easyui-linkbutton" iconCls="icon-ok"
			onclick="saveProductType()">Save</a> <a href="#"

...
<script type="text/javascript" src="${ctx}/res/js/office.js"></script>
<style type="text/css">
body {
	margin: 0;
}
...
<body style="visibility: visible;">
	<table id="view" idField="id" rownumbers="true" pagination="true"
		...
		<thead>
			<tr>
				...
				<th field="officeName" align="center" width="auto"
					editor="{type:'validatebox',options:{required:true}}">职位名称</th>
	...
	<div id="tb">
		<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true"
			onclick="newOffice()">新增</a> 
			<a href="#" class="easyui-linkbutton"
			iconCls="icon-edit" plain="true" onclick="editOffice()">编辑</a> 
			<a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true"
			onclick="removeOffice()">删除</a> 
	</div>
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post" novalidate>
			<div class="fitem">
				<label>职位名:</label> <input name="officeName" id="officeName"
	...
	<div id="dlg-buttons">
		<a href="#" class="easyui-linkbutton" iconCls="icon-ok"
			onclick="saveOffice()">Save</a> <a href="#"
